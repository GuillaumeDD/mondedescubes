  ...
  */
    ...
    public:
      ...
      */
	  ...
	  /*!
      * \brief Verification d'un élément de la regle generale: les cubes sont-ils surcharges?
      * \return true si le cas est verifiee, false sinon
      */
	  bool pasSurcharges();

	  /*!
      * \brief Verification d'un élément de la regle generale: les cubes seront-ils surcharges?
      * \return true si le cas est verifiee, false sinon
      */
