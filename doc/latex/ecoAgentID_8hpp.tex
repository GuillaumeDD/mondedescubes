...
\begin{CompactList}\small\item\em Identifiant unique d'un eco-agent. \item\end{CompactList}\end{CompactItemize}
...
Implementation de la classe \hyperlink{classEcoAgentID}{EcoAgentID} qui est un identifiant unique d'un eco-agent 