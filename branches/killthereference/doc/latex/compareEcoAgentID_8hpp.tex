...
\begin{CompactList}\small\item\em Structure contenant la redefinition de l'operateur de comparaison d'EcoAgentID pour le transformer en cle unique d'une map. \item\end{CompactList}\end{CompactItemize}
